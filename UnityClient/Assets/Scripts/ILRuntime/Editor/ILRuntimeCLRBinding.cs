...
public static class ILRuntimeCLRBinding
{
    ...
    static void GenerateCLRBinding()
    {
        ...
        ILRuntime.Runtime.CLRBinding.BindingCodeGenerator.GenerateBindingCode(types, "Assets/Scripts/ILBinding");
...
#if ILRuntime
    [MenuItem("Tools/ILRuntime/切换到Mono模式", false, 10)]
    static void UseMono()
    {
...
#else
    [MenuItem("Tools/ILRuntime/切换到ILRuntime模式", false, 10)]
